...
let timeserie1 =
  seriesDurations[0].days * 24 * 60 +
  seriesDurations[0].hours * 60 +
  seriesDurations[0].minutes;
let timeserie2 =
  seriesDurations[1].days * 24 * 60 +
  seriesDurations[1].hours * 60 +
  seriesDurations[1].minutes;
let timeserie3 =
  seriesDurations[2].days * 24 * 60 +
  seriesDurations[2].hours * 60 +
  seriesDurations[2].minutes;
...
function showStatus(activities) {
  ...
  console.log(
    `You have added ${activities.length} activites.They amount ${totalDuration} min. of usage.`
  );
  if ((totalDuration = 0)) {
