...
const moviesWithShortTitle = movies.filter((movie) => movie.title.length <= 10);
...
// ---------------------------Tagkeys------------------
const tagKey = movies.filter(function (movie) {
  if (movie.rating >= 7) {
    tag = "Good";
...
// ----------------------------Chaining----------------------------
const chainRating = movies
  .filter((movie) => movie.rating > 6)
  .map((movie) => movie.rating);
console.log(chainRating);

//-----------------------Keywords------------
// const words = ["Surfer", "Alien", "Benjamin"];
// const countMoviesWithKeyword = words.some((word) =>
//   movies.title.includes(word)
// ).length;
// console.log(countMoviesWithKeyword);

// ----------------Duplicated words------------------
const movieTitleArray = movies.filter((movie) => movie.title.split(" "));
const findDuplicates = (movieTitleArray) =>
  movieTitleArray.filter(
    (item, index) => movieTitleArray.indexOf(item) !== index
  );
const duplicateElements = findDuplicates(movieTitleArray);
console.log(duplicateElements);

// ------------------------Average rating-------------------

const averageRating = movies.filter((movie) => movie.title);
